...
# Added activities-13.o
OBJS = main.o prompt-1.o command-2.o hop-3.o reveal-4.o log-5.o proclore-7.o seek-8.o myshrc-9.o ioredir-10.o pipes-11.o activities-13.o
...
main.o: main.c header.h prompt-1.h command-2.h log-5.h myshrc-9.h activities-13.h
	$(CC) $(CFLAGS) -c main.c

prompt-1.o: prompt-1.c header.h prompt-1.h
	$(CC) $(CFLAGS) -c prompt-1.c

command-2.o: command-2.c header.h command-2.h hop-3.h reveal-4.h log-5.h proclore-7.h seek-8.h myshrc-9.h pipes-11.h activities-13.h
...
pipes-11.o: pipes-11.c header.h pipes-11.h ioredir-10.h command-2.h activities-13.h
