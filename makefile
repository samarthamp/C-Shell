...
# Added proclore-7.o
OBJS = main.o prompt-1.o command-2.o hop-3.o reveal-4.o log-5.o proclore-7.o
...
main.o: main.c header.h prompt-1.h command-2.h log-5.h
	$(CC) $(CFLAGS) -c main.c

prompt-1.o: prompt-1.c header.h prompt-1.h
	$(CC) $(CFLAGS) -c prompt-1.c

command-2.o: command-2.c header.h command-2.h hop-3.h reveal-4.h log-5.h proclore-7.h
