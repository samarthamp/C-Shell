...
OBJS = main.o prompt-1.o command-2.o hop-3.o reveal-4.o log-5.o proclore-7.o seek-8.o
...
command-2.o: command-2.c header.h command-2.h hop-3.h reveal-4.h log-5.h proclore-7.h seek-8.h
